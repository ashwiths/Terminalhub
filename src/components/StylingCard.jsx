    ...
    return (
        <div className="flex flex-col gap-1.5">
            <div className="flex items-start gap-2 mt-2">
                <span className="text-brand-cyan font-mono text-xs font-bold select-none whitespace-nowrap">
                    Step {number}
                </span>
...
export default function StylingCard({ fw, onShowSteps }) {
    ...
    return (
        ...
        >
            ...
            {/* ── Quick install ─── */}
            <div className="flex items-center gap-2 bg-surface-900 border border-surface-500 rounded-xl px-4 py-3">
