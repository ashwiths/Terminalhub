...
import { docsFrameworks, docsCategories } from '../data/docsData.js';
import DocsCard, { DOCS_TABS, StepRow } from '../components/DocsCard';
        ...
        <main className="min-h-screen relative">
            ...
            <section className="max-w-7xl mx-auto px-6 pt-14 pb-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-2">
                    <div>
                        <p className="text-[#25c2a0] font-mono text-xs font-bold tracking-widest uppercase mb-3">
                            Documentation
                        </p>
                        ...
                        <p className="text-slate-400 text-lg max-w-2xl">
                            Markdown-first frameworks and static site generators for beautiful technical documentation.
                        </p>
                    </div>
                    <div className="flex items-center gap-2 bg-surface-700 border border-surface-500 rounded-xl px-5 py-3 self-start md:self-auto">
                        <span className="font-mono text-[#25c2a0] text-2xl font-black">{docsFrameworks.length}</span>
            ...
            <section className="max-w-7xl mx-auto px-6 pb-8">
                <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            type="text"
                            placeholder="Search Docs frameworks…"
                            value={search}
                         ...
                         focus:border-[#25c2a0] focus:ring-2 focus:ring-[#25c2a0]/20 transition-all"
                        />
                        {search && (
                            <button
                                onClick={() => setSearch('')}
            ...
            <section className="max-w-7xl mx-auto px-6 pb-24">
                <p className="text-xs text-slate-600 font-mono mb-5">
                    Showing <span className="text-[#25c2a0]">{filtered.length}</span> of {docsFrameworks.length} frameworks
                ...
                {filtered.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-32 gap-4 text-center">
                        ...
                        <button
                            ...
                            className="mt-2 px-5 py-2.5 rounded-xl border border-[#25c2a0]/40 text-[#25c2a0]
                         text-sm font-medium hover:bg-[#25c2a0]/10 transition-all"
                        >
                            Clear filters
                        </button>
                    </div>
                    ...
                    <div className="columns-1 sm:columns-2 lg:columns-3 gap-5 space-y-5">
                        {filtered.map((fw) => (
                            <div key={fw.id} className="break-inside-avoid rounded-2xl">
                                <DocsCard fw={fw} onShowSteps={setSelectedFw} />
                            </div>
                        ))}
                    </div>
                )}
            ...
            {selectedFw && (
                ...
                >
                    <div
                     ...
                     shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9),0_0_0_1px_rgba(37,194,160,0.2)]
                            ...
                            <div className="flex gap-2 p-1 mb-8 bg-surface-800 border border-surface-500 rounded-xl w-fit">
                                {DOCS_TABS.map((t) => (
                                    <button
                                        key={t.id}
                                        onClick={() => setPm(t.id)}
                                        className={`px-5 py-2 rounded-lg text-sm font-bold font-mono transition-all duration-150 ${pm === t.id
